...
class TestService:
    ...
    async def get_test_result_by_id(self, result_id: int) -> TestResult | None:
        return await self.test_repo.get_test_result_by_id(result_id)
        
    async def get_formula_result_by_id(self, result_id: int) -> FormulaResult | None:
        return await self.test_repo.get_formula_result_by_id(result_id)
